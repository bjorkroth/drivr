...
class MissionAllExercisesDone extends StatelessWidget {
  final String title;
  const MissionAllExercisesDone({super.key, required this.title});
        ...
        child: Center( child: Padding(
            ...
            child: Column(
              children: [
                ...
                const Text("All exercises already done for this mission",
